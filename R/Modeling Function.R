...
#' @export
modeling_func2 = function(df, target_y, title = "", num_threads_params=23, train_span=36, push_span=1, ensemble_n = 300, bagging_prop=0.8, feature_prop=0.8, num_rounds=60, pred_start_date = '2017-01-01', explain_yn = 'Y', focal_loss_yn = 'N') {

...
#' @export
backtest_portfolio =
  function(test_title="Portfolio Return", ssl_list, topN, pred_col, FN_ratio, SN_ratio, include_issue, upper_bound, lower_bound, min_transaction_amount, safe_haven = NA, weight_list = NA, start_date = '20150106', end_date = '99991231', load_data = 'Y') {
...
backtest_portfolio_tic =
  function(test_title="Portfolio Return", ssl_list, topN, pred_col, SN_ratio, FN_ratio, include_issue, upper_bound, lower_bound, safe_haven = NA, weight_list = NA, start_date = '20180101', end_date = '20201230', load_data = 'Y') {
